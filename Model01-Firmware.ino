...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,             Key_1,       Key_2,         Key_3,        Key_4, Key_5, Key_KeypadNumLock,
   Key_Backtick,    Key_Q,       Key_W,         Key_E,        Key_R, Key_T, Key_LeftBracket,
   Key_Slash,       Key_A,       Key_S,         Key_D,        Key_F, Key_G,
   ...
   ___,               Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_RightShift,
